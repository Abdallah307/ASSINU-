  ...
  const fetchReplays = async () => {
    try {
      const response = await axios.get(
        `http://${HOST}:${SERVER_PORT}/${params.groupName}/posts/comments/${params.comment._id}/replays`,
        {
          headers: {
  ...
  const submitReplay = async () => {
    try {
      ...
      const response = await axios.post(
        `http://${HOST}:${SERVER_PORT}/${params.groupName}/posts/comments/addreplay`,
        {
          comment: params.comment._id,
          content: inputValue,
        },
        {
          headers: {
...
export default PostReplaysScreen;
